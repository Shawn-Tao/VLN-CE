...
class Json_Templater:
    def __init__(self):
        ...
        # path_prefix = "r2r_envdrop"
        # path_prefix = "r2r_train_320"
        ...
        for folder in folder_list:
            ...
            for step in range(len(action_list)):
                ...
                if(step == 0):
                    ...
                    image_list.append(f"{self.path_prefix}/{episode_id}/{episode_id}_{step}.jpg")
                    ...
                    for i in range(step):
                        ...
                        image_list.append(f"{self.path_prefix}/{episode_id}/{episode_id}_{step-i-1}.jpg")
                    image_list.reverse()    
                    # image_list.append(f"{folder}/{episode_id}_{merged_indices[step][0]}.jpg")
                    image_list.append(f"{self.path_prefix}/{episode_id}/{episode_id}_{step}.jpg")
                else:
